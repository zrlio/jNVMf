...
public class ControllerStatus {
     ...
     * NVM Spec 1.3a - 3.1.6
     */
    private final static int BASE_OFFSET = 0x1c;
    public final static Property PROPERTY =
            new Property(Property.Size.getInstance().FOUR_BYTES, BASE_OFFSET);

    private final static int READY_BITOFFSET = 0;
    private final static int FATAL_STATUS_BITOFFSET = 1;
    private final static int SHUTDOWN_STATUS_BITOFFSET_START = 2;
    private final static int SHUTDOWN_STATUS_BITOFFSET_END = 3;
    private final static int NVM_SUBSYSTEM_RESET_OCCURED_BITOFFSET = 4;
    private final static int PROCESSING_PAUSED_BITOFFSET = 5;
    ...
    public static class ShutdownStatus extends EEnum<ShutdownStatus.Value> {
        ...
        public Value NORMAL_OPERATION = new Value(0x0);
        public Value SHUTDOWN_PROCESSING = new Value(0x1);
        public Value SHUTDOWN_COMPLETE = new Value(0x2);

        private ShutdownStatus() {
            super(0x2);
        }

        private final static ShutdownStatus instance = new ShutdownStatus();
