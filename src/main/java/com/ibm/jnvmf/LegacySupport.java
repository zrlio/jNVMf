...
public class LegacySupport {
    ...
    final static boolean ENABLED = Boolean.parseBoolean(System.getProperty("jnvmf.legacy", "false"));
    ...
    static void initializeSubmissionQueueEntry(NativeBuffer buffer) {
         ...
         * buffer that is byte aligned." although metadata is not supported by the kernel at the moment */
