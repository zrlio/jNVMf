...
public class ControllerCapabilities {
     ...
     */
    private final static int OFFSET = 0x00;
    public static Property PROPERTY =
            new Property(Property.Size.getInstance().EIGHT_BYTES, OFFSET);

    private final static int MAXIMUM_QUEUE_ENTRIES_SUPPORTED_BITOFFSET_START = 0;
    private final static int MAXIMUM_QUEUE_ENTRIES_SUPPORTED_BITOFFSET_END = 15;
    private final static int CONTIGUOUS_QUEUE_ENTRIES_REQUIRED_BITOFFSET = 16;
    private final static int ARBITRATION_MECHANISM_SUPPORTED_BITOFFSET_START = 17;
    private final static int ARBITRATION_MECHANISM_SUPPORTED_BITOFFSET_END = 18;
    private final static int TIMEOUT_BITOFFSET_START = 24;
    private final static int TIMEOUT_BITOFFSET_END = 31;
    private final static int NVM_SUBSYSTEM_RESET_SUPPORTED_BITOFFSET = 36;
    private final static int BOOT_PARTITION_SUPPORT_BITOFFSET = 45;
    private final static int MEMORY_PAGE_SIZE_MINIMUM_BITOFFSET_START = 48;
    private final static int MEMORY_PAGE_SIZE_MINIMUM_BITOFFSET_END = 51;
    private final static int MEMORY_PAGE_SIZE_MAXIMUM_BITOFFSET_START = 52;
    private final static int MEMORY_PAGE_SIZE_MAXIMUM_BITOFFSET_END = 55;
    ...
    public long getMaximumQueueEntriesSupported() {
        return BitUtil.getBits(value,
                MAXIMUM_QUEUE_ENTRIES_SUPPORTED_BITOFFSET_START, MAXIMUM_QUEUE_ENTRIES_SUPPORTED_BITOFFSET_END) + 1;
    }
    ...
    public static class ArbitrationMechanism extends EEnum<ArbitrationMechanism.Value> {
        ...
        private final static ArbitrationMechanism instance = new ArbitrationMechanism();
