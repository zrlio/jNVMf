...
public class GenericStatusCode extends StatusCode {
    ...
    public final Value INVALID_FIELD =
            new Value(0x2, "A reserved coded value or an unsupported value in a defined field (other than opcode field)");
    ...
    public final Value DATA_TRANSFER_ERROR =
            new Value(0x4, "Transferring the data or metadata associated with a command had an error.");
    ...
    public final Value COMMAND_SEQUENCE_ERROR =
            new Value(0xc, "The command was aborted due to a protocol violation in a multicommand " +
    ...
    public final Value DATA_SGL_LENGTH_INVALID =
            new Value(0xf, "This may occur if the length of a Data SGL is too short. This may occur " +
    ...
    private final static GenericStatusCode instance = new GenericStatusCode();
