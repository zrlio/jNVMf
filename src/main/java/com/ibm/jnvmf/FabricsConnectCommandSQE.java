...
public final class FabricsConnectCommandSQE extends FabricsSubmissionQueueEntry {
    ...
    private final static int RECORD_FORMAT_OFFSET = 40;
    private final static int QUEUE_ID_OFFSET = 42;
    private final static int SUBMISSION_QUEUE_SIZE_OFFSET = 44;
    /* Connection attribute is only relevant for weighted round robin - we don't support it for now */
    private final static int CONNECT_ATTRIBUTES_OFFSET = 46;
    private final static int KEEP_ALIVE_TIMEOUT_OFFSET = 48;
