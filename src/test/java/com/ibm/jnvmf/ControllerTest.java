...
class ControllerTest {
    ...
    void shutdown() throws IOException {
        Controller controller = connectController();
        ControllerStatus status = controller.getControllerStatus();
        assertEquals(ControllerStatus.ShutdownStatus.getInstance().NORMAL_OPERATION, status.getShutdownStatus());
        ControllerConfiguration configuration = controller.getControllerConfiguration();
        ...
        status = controller.getControllerStatus();
        assertTrue(ControllerStatus.ShutdownStatus.getInstance().SHUTDOWN_PROCESSING.equals(status.getShutdownStatus()) ||
                ControllerStatus.ShutdownStatus.getInstance().SHUTDOWN_COMPLETE.equals(status.getShutdownStatus()));
    }
    ...
    void createIOQueue() throws IOException, TimeoutException {
        ...
        }
        {
            ...
            controller.syncConfiguration();
            controller.waitUntilReady();
            assertThrows(IllegalArgumentException.class, () -> controller.createIOQueuePair(32, -1, 0, 0));
            controller.free();
        }
        {
            Controller controller = connectController();
            ...
            controller.syncConfiguration();
            controller.waitUntilReady();
            assertThrows(IllegalArgumentException.class, () -> controller.createIOQueuePair(32, 0, -1, 0));
            controller.free();
        }
        {
            Controller controller = connectController();
            ...
            controller.syncConfiguration();
            controller.waitUntilReady();
            assertThrows(IllegalArgumentException.class, () -> controller.createIOQueuePair(32, 0, 0, -1));
            controller.free();
        }
        {
            Controller controller = connectController();
            ...
            controller.syncConfiguration();
            controller.waitUntilReady();
            assertThrows(IllegalArgumentException.class, () -> controller.createIOQueuePair(32, Integer.MAX_VALUE, 0, 0));
            controller.free();
        }
        {
            Controller controller = connectController();
            ...
            controller.syncConfiguration();
            controller.waitUntilReady();
            assertThrows(IllegalArgumentException.class, () -> controller.createIOQueuePair(32, 0, Integer.MAX_VALUE, 0));
            controller.free();
        }
        {
            Controller controller = connectController();
            ...
            controller.syncConfiguration();
            controller.waitUntilReady();
            assertThrows(IOException.class, () -> controller.createIOQueuePair(32, 0, 0, Integer.MAX_VALUE));
            controller.free();
        }
        {
            Controller controller = connectController();
