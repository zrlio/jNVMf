...
class BitUtilTest {
    ...
    void getBits() {
        ...
        assertThrows(IllegalArgumentException.class, () -> BitUtil.getBits(~0, Integer.SIZE, Integer.SIZE));
    }
    ...
    void clearBits() {
        ...
        assertThrows(IllegalArgumentException.class, () -> BitUtil.clearBits(~0, Integer.SIZE, Integer.SIZE));
    }
    ...
    void setBitsTo() {
        ...
        assertThrows(IllegalArgumentException.class, () -> BitUtil.setBitsTo(0, Integer.SIZE, Integer.SIZE, 1));
